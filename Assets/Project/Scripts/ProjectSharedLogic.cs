...
public static class ProjectSharedLogic
{
    ...
    public static string SENTENCE_QUESTION_KEY(string learnLanguage, string sectionName, List<string> words) => $"{learnLanguage}/{sectionName}/{string.Join("|", words)}";
    public static string SENTENCE_QUESTION_LOCALIZATION_KEY(string learnLanguage, string sectionName, List<string> words) => $"{learnLanguage}/Sentences/{sectionName}/{string.Join("|", words)}";
}