        ...
        try
        {
            foreach (var folder in _folders)
            {
                ...
                foreach (var groupedHash in groupedHashes)
                {
                    ...
                    {
                        Debug.Log($"hash: {hash}");
                        // !!!!!!! create question config asset. But Where? need to set folder (and create folder)
                        ...
                        WordConfigFileCreator.CreateQuestSelectWordConfig(correctWord.Key, questionConfig);
                        Debug.Log($"Quest Config: {questionConfig.name} created at:\n PATH!!!");
                    }
                }
            }
        }
